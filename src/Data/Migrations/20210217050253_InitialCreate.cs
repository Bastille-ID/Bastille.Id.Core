    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("41e1d669-53b1-431d-ba1d-7bafca4a9b50"), @"$FIRSTNAME$,
                ...
                If you did not request a password reset, please contact us.", null, new DateTime(2021, 2, 17, 5, 2, 53, 456, DateTimeKind.Utc).AddTicks(1902), "en-US", null, "reset_password_en-US_txt", "Message", null, null },
                    { new Guid("9a1cb149-67dd-4b7f-bf91-d3566d9a17bf"), @"<html>
                <head>
                ...
                </html>", null, new DateTime(2021, 2, 17, 5, 2, 53, 457, DateTimeKind.Utc).AddTicks(934), "en-US", null, "reset_password_en-US_htm", "Message", null, null },
                    { new Guid("9a151f65-7673-4e88-9f77-f2104a76de64"), @"$FIRSTNAME$,

                Please click the link below to verify your e-mail address and activate your account.

                $LINK$", null, new DateTime(2021, 2, 17, 5, 2, 53, 457, DateTimeKind.Utc).AddTicks(1912), "en-US", null, "verify_account_en-US_txt", "Message", null, null },
                    { new Guid("34c00483-ae50-465b-b8d1-4fb9c82dfd8e"), @"<html>
                <head>
                    <title>Reset Your Password</title>
                    <style>
                ...
                </html>", null, new DateTime(2021, 2, 17, 5, 2, 53, 457, DateTimeKind.Utc).AddTicks(2614), "en-US", null, "verify_account_en-US_htm", "Message", null, null }
                });
